...
model="$repo_root/model_training/experiments/v8_parent_c2612_d6_d24pca2_qanchor_20260521_0002/s2d_c2_6_12_d6_shadow_init/parent_int8.tflite"
...
grep -Fq "output name=StatefulPartitionedCall_1:0 type=INT8 shape=1x6" <<<"$output"
