# steering-domain-architecture Specification

## Purpose
Define the active steering domain-layer ownership tree, dependency direction, and behavior-preservation expectations for the `new/code/` workspace.
