# steering-architecture-migration-workflow Specification

## Purpose
Define the planning, verification, and review workflow expectations for broad steering architecture migrations.
