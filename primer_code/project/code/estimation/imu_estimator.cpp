...
{
    primer::port::ApplyLowPass(hz, time, in, out);
}
                           ...
                           float *yaw_huandao_error)
{
    ...
    {
        if((current_yaw>=-180)&&current_yaw<(-180+yaw_huandao))
        {
            *yaw_correct_value=current_yaw+360;
            *yaw_huandao_error=yaw_huandao-*yaw_correct_value;
        }
        else *yaw_huandao_error=yaw_huandao-current_yaw;
    }
